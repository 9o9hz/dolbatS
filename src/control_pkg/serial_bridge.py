...
class CmdVelSerialBridge(Node):
    """Convert /cmd_vel Twist messages to Dolsoi Arduino serial commands."""
    ...
    def __init__(
        ...
        self.declare_parameter("baud_rate", 9600 if baudrate is None else baudrate)
...
def parse_args(
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help="Arduino serial baudrate, for example 9600.",
    )
