...
class LaneDriveNode(Node):
    ...
    def __init__(self, cli_args: argparse.Namespace) -> None:
        ...
        defaults = {
            ...
            "vehicle_reference_x_px": -1.0,
            "process_every_nth_frame": 1,
            "pixels_per_meter_x": 533.3333333333,
            "pixels_per_meter_y": 533.3333333333,
        ...
        plan_config = LaneConfig(
            ...
            vehicle_reference_x_px=float(
                parameter("vehicle_reference_x_px")
            ),
            pixels_per_meter_x=float(parameter("pixels_per_meter_x")),
