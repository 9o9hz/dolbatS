...
class SegmentationLaneProcessor:
    ...
    def _extract_bbox_pieces(
        ...
        """Extract one piece from each YOLO detection's isolated mask."""

        pieces: List[LaneGroup] = []
        for instance in instances:
            detection_mask = np.asarray(instance["mask"], dtype=np.uint8)
    ...
    def plan_mask(
        ...
        Each YOLO detection carries its own isolated mask, preventing
        neighboring solid/dashed detections from bleeding into each other.
        """
